...
| Strategic Framing | ACTIVE_V2_BASELINE / APPROVED EXPERIENCE BASELINE (SF-0) | PARTIAL_IMPLEMENTATION / IMPLEMENTED_UNVERIFIED (SF-1 through SF-4D) | V2_TARGET_DEFINED | TESTING | SF-4D boundary verification passes with no runtime/schema/persistence change; deployed/runtime certification and canonical promotion remain pending |
