...
| Strategic Framing | ACTIVE_V2_BASELINE / APPROVED EXPERIENCE BASELINE (SF-0) | PARTIAL_IMPLEMENTATION / IMPLEMENTED_UNVERIFIED (SF-1 through SF-4C) | V2_TARGET_DEFINED | TESTING | SF-4C advisory workspace integration implemented with focused evidence; runtime certification and canonical promotion remain pending |
