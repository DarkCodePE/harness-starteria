...
| Strategic Framing | ACTIVE_V2_BASELINE / APPROVED EXPERIENCE BASELINE (SF-0) | PARTIAL_IMPLEMENTATION / IMPLEMENTED_UNVERIFIED (SF-1 through SF-4B) | V2_TARGET_DEFINED | TESTING | SF-4B evaluator/read boundary implemented with focused evidence; runtime certification, SF-4C interaction and canonical promotion remain pending |
