...
| Strategic Framing | ACTIVE_V2_BASELINE / APPROVED EXPERIENCE BASELINE (SF-0) | PARTIAL_IMPLEMENTATION / IMPLEMENTED_UNVERIFIED (SF-1 through SF-3D) | V2_TARGET_DEFINED | TESTING | SF-3D multi-entry boundary implemented; SF-3E boundary/E2E verification, Copilot and canonical promotion remain pending |
