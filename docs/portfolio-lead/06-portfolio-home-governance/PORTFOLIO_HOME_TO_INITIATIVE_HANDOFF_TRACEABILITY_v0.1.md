...
activation is compatible with Core v0.2. Activation Readiness, `pre_start`,
exact ownership transition semantics, Challenge coverage/cardinality and
expanded Decision Authority semantics are `CANDIDATE DEPENDENCY /
ADR-RETEST REQUIRED`.
