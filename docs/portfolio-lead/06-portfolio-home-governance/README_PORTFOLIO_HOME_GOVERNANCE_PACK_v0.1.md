...
STARTERIA_AUTHORITY
        ↓
CORE LOGIC CONTRACT v0.2 FACTUAL
        ↓
...
- Activation Readiness and its exact lifecycle/transitions;
- exact `pre_start` lifecycle and technical representation;
- ownership transition semantics and any expanded Decision Authority semantics;
