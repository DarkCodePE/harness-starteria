...
semantics are compatible with v0.2. The `activation_state` value `pre_start`,
its technical representation, ownership transitions, coverage/cardinality and
Decision Authority semantics are `CANDIDATE DEPENDENCY / ADR-RETEST REQUIRED`.
