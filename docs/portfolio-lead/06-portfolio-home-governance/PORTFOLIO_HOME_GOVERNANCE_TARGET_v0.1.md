...
The exact `pre_start` lifecycle, Activation Readiness states, ownership and
Decision Authority semantics, Challenge coverage/cardinality, and exact moment
of Step materialization are `CANDIDATE DEPENDENCY / ADR-RETEST REQUIRED`.
