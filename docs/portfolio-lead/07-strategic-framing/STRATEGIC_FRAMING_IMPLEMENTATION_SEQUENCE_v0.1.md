...
**Estado:** `CANDIDATE` — secuencia futura congelada en SF-0. Ninguna slice de esta lista se ejecuta en este cambio.
...
| SF-6 | Promote Gap → Challenge | Explicit human confirmation with downstream boundaries preserved | Not started |
...
- No slice may change Core, role authority, Initiative identity, lifecycle or Front → Challenge cardinality silently.
