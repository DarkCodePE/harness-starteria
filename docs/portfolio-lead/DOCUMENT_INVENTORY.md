...
| `STRATEGIC_FRAMING_CONTEXT_v0.1.md` | `docs/portfolio-lead/07-strategic-framing/STRATEGIC_FRAMING_CONTEXT_v0.1.md` | v0.1 | APPROVED CONTEXT / EXPERIENCE REFERENCE | Strategic Framing | SF-0 human-approved 2026-09-24; implementation slices remain bounded and do not create runtime authority. | KEEP_IN_PLACE |
| `STRATEGIC_FRAMING_*_v0.1.md` | `docs/portfolio-lead/07-strategic-framing/` | SF-0–SF-3B | APPROVED CONTRACT / IMPLEMENTATION EVIDENCE | Strategic Framing package | SF-0 approved; SF-1 audit completed; SF-2 read model implemented; SF-3A approved; SF-3B provisional persistence/application state implemented but unverified; SF-3C+ not implemented. | KEEP_IN_PLACE |
