...
| `ADR-001-portfolio-entry-continuation-to-portfolio.md` | `doc/product-adr/ADR-001-portfolio-entry-continuation-to-portfolio.md` | ADR-001 | TARGET_CANDIDATE | Product ADR proposed | Proposed Portfolio continuation decision; not approved authority. | KEEP_IN_PLACE |
...
| `PORTFOLIO_ENTRY_LOGIC_CONTRACT_v0.1.md` | `doc/experience/portfolio-entry/PORTFOLIO_ENTRY_LOGIC_CONTRACT_v0.1.md` | v0.1 | CURRENT_CONTRACT | Approved Experience Contract | Canonical active Portfolio Entry Experience Contract; single physical copy with active consumers. | KEEP_IN_PLACE |
...
| --- | --- | --- | --- |
| Portfolio Entry logic | Canonical `doc/experience/portfolio-entry/PORTFOLIO_ENTRY_LOGIC_CONTRACT_v0.1.md` | No v0.2 logic contract installed | Single active v0.1 Experience Contract; `docs/experience/portfolio-entry/` is reserved for the installed candidate clarification/value stack. |
