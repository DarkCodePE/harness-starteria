...
| `PORTFOLIO_ENTRY_LOGIC_CONTRACT_v0.1.md` | Target: `docs/experience/portfolio-entry/PORTFOLIO_ENTRY_LOGIC_CONTRACT_v0.1.md`; observed: `doc/experience/portfolio-entry/PORTFOLIO_ENTRY_LOGIC_CONTRACT_v0.1.md` | v0.1 | CURRENT_CONTRACT | Approved Experience Contract | Declared active authority; legacy/current source has active consumers and requires path reconciliation. | LEGACY_SOURCE_PRESENT / TARGET_PATH_NOT_MATERIALIZED; KEEP_BASELINE / RECONCILE_PATH |
...
| --- | --- | --- | --- |
| Portfolio Entry logic | Target `docs/experience/portfolio-entry/PORTFOLIO_ENTRY_LOGIC_CONTRACT_v0.1.md`; observed `doc/experience/portfolio-entry/PORTFOLIO_ENTRY_LOGIC_CONTRACT_v0.1.md` | No v0.2 logic contract installed | Legacy/current source remains active; reconcile path and consumers before promotion. |
