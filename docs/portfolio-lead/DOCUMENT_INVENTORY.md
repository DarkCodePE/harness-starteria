...
| `STRATEGIC_FRAMING_CONTEXT_v0.1.md` | `docs/portfolio-lead/07-strategic-framing/STRATEGIC_FRAMING_CONTEXT_v0.1.md` | v0.1 | APPROVED CONTEXT / EXPERIENCE REFERENCE | Strategic Framing | SF-0 human-approved 2026-09-24; no runtime authority. | KEEP_IN_PLACE |
| `STRATEGIC_FRAMING_*_v0.1.md` | `docs/portfolio-lead/07-strategic-framing/` | SF-0 | APPROVED EXPERIENCE BASELINE | Strategic Framing package | SF-0 approved; runtime not implemented; SF-1–SF-8 not executed. | KEEP_IN_PLACE |
