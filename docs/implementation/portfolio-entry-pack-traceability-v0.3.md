...
| Experience Contract activo | `docs/experience/portfolio-entry/PORTFOLIO_ENTRY_LOGIC_CONTRACT_v0.1.md` | aprobado como base de experiencia para Pantalla 1 |
...
| PL-INVENTORY-01 inventario declarado no equivale a inventario analizado | 05, 12, 13 | Experience v0.1; harness fixtures PE | `docs/experience/portfolio-entry/PORTFOLIO_ENTRY_LOGIC_CONTRACT_v0.1.md` | PE fixtures | N/A | PE-A02/portfolio fixtures | parcial | no existe ID PL literal | crear mapping PL-xx sin renombrar PE |
