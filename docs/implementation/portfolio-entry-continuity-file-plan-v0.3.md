> HISTORICAL / PLAN: ver ../../CURRENT_STATE.md. Este plan no autoriza incorporar backend/, front/, Prisma, runtime ni tests productivos en este repositorio publico. No duplica el contrato activo; usar ../experience/portfolio-entry/PORTFOLIO_ENTRY_LOGIC_CONTRACT_v0.1.md.
