import type { PortfolioEntryAnalysisV2, QuestionPlanV2 } from '../schemas/analysis.schema';
...
export type ScriptedResponseResult = {
...
export type PortfolioEntrySessionFixture = MultiTurnFixtureV2;

export function createInitialSessionContext(fixture: PortfolioEntrySessionFixture): SessionContext {
  return {
    interaction_mode: fixture.session.initial_mode,
    quick_question_budget: fixture.session.quick_question_budget,
