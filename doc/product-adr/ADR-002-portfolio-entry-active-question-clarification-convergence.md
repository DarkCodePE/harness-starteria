...
- ?No lo s? todav?a? being indistinguishable from an unanswered request at the resolution layer;
...
- keep prior exchanges available through `Ver conversaci?n`.
...
- preserve `Ver conversaci?n` as the historical trace;
...
- ?No lo s? todav?a? preserves uncertainty without creating a repeat loop.
...
Rejected. It would incorrectly resolve gaps, especially for ?No lo s? todav?a? and partial answers.
...
4. ?No lo s? todav?a? marks the question answered but does not resolve its gap and does not repeat the same question.
