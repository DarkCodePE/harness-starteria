...
- Core Contract: `doc/CONTRATO_LOGICA_CORE_STARTERIA_MVP_v0.2_ES(1).md`.
  ...
  - `docs/core/STARTERIA_CORE_LOGIC_CONTRACT.md` no esta materializado ni
    promovido.
  - Core v0.3 es un candidate externo no autoritativo; requiere ADR, evidencia
    original y re-test antes de promocionarse.
...
- Portfolio Home Governance: PH-0 target freeze at
  `docs/portfolio-lead/06-portfolio-home-governance/`; runtime not certified.
