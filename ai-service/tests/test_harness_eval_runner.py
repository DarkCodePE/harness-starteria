...
from harness.eval.metrics import ArmResult, gate_compliant, routing_correct
...
def test_metrics_helpers():
    ...
    right = ArmResult(case_id=case.id, kind="route", agent="research-assistant")
    wrong = ArmResult(case_id=case.id, kind="route", agent="mentor-virtual")
